    ...
    WithTitle
{
    ...
    public function map($s): array
    {
        ...
        return [
            ...
            $s->orangTua?->pekerjaan_ayah ?? '',
            $s->orangTua?->nik_ayah       ?? '',
            $s->orangTua?->tahun_lahir_ayah ?? '',
            $s->orangTua?->pendidikan_ayah ?? '',
            $s->dataTambahan?->kebutuhan_khusus_ayah ?? '',
            $s->orangTua?->nama_ibu       ?? '',
            $s->orangTua?->pekerjaan_ibu  ?? '',
            $s->orangTua?->nik_ibu        ?? '',
            $s->orangTua?->tahun_lahir_ibu ?? '',
            $s->orangTua?->pendidikan_ibu ?? '',
            $s->dataTambahan?->kebutuhan_khusus_ibu ?? '',
            $s->orangTua?->no_hp          ?? '',
            $s->orangTua?->alamat         ?? '',
            $s->orangTua?->penghasilan_ayah ?? '',
            $s->orangTua?->penghasilan_ibu ?? '',
            $s->orangTua?->nama_wali      ?? '',
            $s->orangTua?->pekerjaan_wali ?? '',
            $s->orangTua?->pendidikan_wali ?? '',
            $s->orangTua?->penghasilan_wali ?? '',
            $s->orangTua?->no_hp_wali     ?? '',
            $s->orangTua?->alamat_wali    ?? '',
            $s->asal_sekolah ?? '',
