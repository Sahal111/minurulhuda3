...
import {
    ...
    ClipboardCheck, Settings, ChevronDown
} from 'lucide-react';

const KepsekSidebar = ({ sidebarOpen, setSidebarOpen, sidebarCollapsed }) => {
            ...
            >
                <div className="p-6 flex items-center gap-4 border-b border-emerald-800">
                    ...
                    {!sidebarCollapsed && (
                        <div className="truncate transition-opacity duration-300">
                            ...
                            <p className="text-[10px] text-emerald-300 uppercase tracking-widest">Kepala Sekolah</p>
                        </div>
                    )}
                </div>
                ...
                <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                    ...
                    <div className="space-y-1">
                        ...
                        {submenus.data && !sidebarCollapsed && (
                            <div className="pl-6 space-y-1 mt-1">
                                <NavLink to="/kepsek/guru" className={linkClasses}>
                                    <UserCheck className="w-4 h-4" /> Data Guru
                                </NavLink>
                                <NavLink to="/kepsek/siswa" className={linkClasses}>
                    ...
                    <div className="space-y-1">
                        ...
                        {submenus.laporan && !sidebarCollapsed && (
                            <div className="pl-6 space-y-1 mt-1">
                                <NavLink to="/kepsek/laporan-akademik" className={linkClasses}>
                                    <BarChart3 className="w-4 h-4" /> Laporan Akademik
                                </NavLink>
                                <NavLink to="/kepsek/laporan-kinerja" className={linkClasses}>
                                    <ClipboardCheck className="w-4 h-4" /> Laporan Kinerja
                                </NavLink>
                            </div>
                        )}
                    </div>
                    ...
                    >
                        ...
                        {!sidebarCollapsed && <span className="font-medium text-sm">Monitoring</span>}
                    </NavLink>
