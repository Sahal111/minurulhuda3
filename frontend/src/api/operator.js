...
export const siswaAPI = {
  ...
  store: (data) =>
    api.post("/operator/data-siswa", data, {
  ...
  import: (data) =>
    api.post("/operator/data-siswa/import", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  exportTemplate: () =>
    api.get("/operator/data-siswa/template", {
      responseType: "blob",
    }),
  exportData: (params = {}) =>
    api.get("/operator/data-siswa/export", {
      params,
      responseType: "blob",
    }),
  exportPdfSatu: (id) =>
    api.get(`/operator/data-siswa/${id}/pdf`, {
      responseType: "blob",
    }),
  ...
  storeBerkas: (siswaId, data) =>
    api.post(`/operator/data-siswa/${siswaId}/berkas`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  ...
  storePrestasi: (siswaId, data) =>
    api.post(`/operator/data-siswa/${siswaId}/prestasi`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  updatePrestasi: (siswaId, prestasiId, data) =>
    api.post(`/operator/data-siswa/${siswaId}/prestasi/${prestasiId}`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  ...
  storeBeasiswa: (siswaId, data) =>
    api.post(`/operator/data-siswa/${siswaId}/beasiswa`, data),
  updateBeasiswa: (siswaId, beasiswaId, data) =>
    api.post(`/operator/data-siswa/${siswaId}/beasiswa/${beasiswaId}`, data),
  destroyBeasiswa: (siswaId, beasiswaId) =>
    api.delete(`/operator/data-siswa/${siswaId}/beasiswa/${beasiswaId}`),
};
...
export const guruAPI = {
  ...
  store: (data) =>
    api.post("/operator/data-guru", data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  update: (id, data) => {
    if (data instanceof FormData) {
  ...
  assignUser: (id, data) =>
    api.post(`/operator/data-guru/${id}/assign-user`, data),
  // Diklat
  getDiklat: (guruId) => api.get(`/operator/data-guru/${guruId}/diklat`),
  storeDiklat: (guruId, data) =>
    api.post(`/operator/data-guru/${guruId}/diklat`, data),
  updateDiklat: (guruId, diklatId, data) =>
    api.put(`/operator/data-guru/${guruId}/diklat/${diklatId}`, data),
  destroyDiklat: (guruId, diklatId) =>
    api.delete(`/operator/data-guru/${guruId}/diklat/${diklatId}`),
  // Inpassing
  getInpassing: (guruId) => api.get(`/operator/data-guru/${guruId}/inpassing`),
  storeInpassing: (guruId, data) =>
    api.post(`/operator/data-guru/${guruId}/inpassing`, data),
  setAktifInpassing: (guruId, inpassingId) =>
    api.patch(`/operator/data-guru/${guruId}/inpassing/${inpassingId}/aktif`),
  destroyInpassing: (guruId, inpassingId) =>
    api.delete(`/operator/data-guru/${guruId}/inpassing/${inpassingId}`),
  // Dokumen
  getDokumen: (id) => api.get(`/operator/data-guru/${id}/dokumen`),
  storeDokumen: (id, data) =>
    api.post(`/operator/data-guru/${id}/dokumen`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  updateDokumen: (id, dokumenId, data) =>
    api.post(`/operator/data-guru/${id}/dokumen/${dokumenId}`, data, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  destroyDokumen: (id, dokumenId) =>
    api.delete(`/operator/data-guru/${id}/dokumen/${dokumenId}`),
  verifyDokumen: (id, dokumenId) =>
    api.patch(`/operator/data-guru/${id}/dokumen/${dokumenId}/verify`),
};
...
export const kelasAPI = {
  ...
  updatePenempatan: (data) =>
    api.post("/operator/penempatan-siswa/update", data),
};
...
export const userManagementAPI = {
  ...
  resetPassword: (id, data) =>
    api.patch(`/operator/manajemen-akun/${id}/reset-password`, data),
};
