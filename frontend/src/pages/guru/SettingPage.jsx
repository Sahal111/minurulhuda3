  ...
  return (
    <div className="p-4 lg:p-8 space-y-8 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Kelola pengaturan akun Anda</p>
      </div>

      <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-6">
        <h3 className="font-bold text-slate-800 mb-6">Profil Saya</h3>
        <div className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-600 mb-1.5">Mata Pelajaran</label>
              <input
                type="text"
                name="mapel"
                value={profile.mapel}
...
export default GuruSettingPage;
