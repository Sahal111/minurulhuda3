...
const dataSiswa = [
  ...
  { nis: '23105', nama: 'Rizky Pratama', kelas: '6A', jk: 'L', status: 'Aktif' },
  { nis: '23106', nama: 'Fitri Handayani', kelas: '6A', jk: 'P', status: 'Aktif' },
  { nis: '23107', nama: 'Agus Wijaya', kelas: '6A', jk: 'L', status: 'Aktif' },
  { nis: '23108', nama: 'Rina Marlina', kelas: '6A', jk: 'P', status: 'Aktif' },
];
  ...
  return (
    <div className="p-4 lg:p-8 space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Daftar siswa yang Anda ajar</p>
      </div>
