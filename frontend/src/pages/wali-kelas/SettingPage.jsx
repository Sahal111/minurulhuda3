...
const WaliKelasSettingPage = () => {
  const [profile, setProfile] = useState({
    nama: 'Aris Setiawan, S.Pd.',
    nip: '198005052005015005',
    email: 'aris.setiawan@minurulhuda3.sch.id',
    kelas: '6A',
    noTelp: '081234567890',
  });
  ...
  return (
    <div className="p-4 lg:p-8 space-y-8 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Pengaturan akun wali kelas</p>
      </div>
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input type="text" name="kelas" value={profile.kelas} className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm bg-slate-50" readOnly />
            </div>
            <div>
...
export default WaliKelasSettingPage;
